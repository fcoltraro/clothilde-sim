...
self = Cloth(X, T); 
dt = 1/60
self.setSimulatorParameters(dt = dt, thck = 0.95, mu_s = 0.35, str = 0.005*1e-4, kappa_bnd = 0.1*1e-4, 
                            shr = 25*1e-4, tol = 0.0075, kappa = 1*1e-4, mu_f = 0.15, sub_steps = 10, slf = 0.0001)
self.plotMesh()
tf = int(3/dt)
