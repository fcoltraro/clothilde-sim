...
dt = 1/60 
self.setSimulatorParameters(dt = dt, thck = 0.95, mu_s = 0.3, tol = 0.0075, shr = 5*1e-4, kappa_flt = 5*1e-4,
                            kappa=0.25*1e-4, kappa_bnd = 0.025*1e-4, str = 0.005*1e-4, sub_steps=10,slf=0*0.005)
self.plotMesh()
