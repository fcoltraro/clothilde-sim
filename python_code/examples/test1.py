...
dt = 1/60 
self.setSimulatorParameters(dt = dt, thck = 1, mu_s = 0.35, tol = 0.0075, shr = 0.15*1e-4, mu_f = 0.4,
                            kappa=0.75*1e-4, kappa_bnd = 0.03*1e-4, str = 0.005*1e-4, sub_steps=6,slf=1e-3)
self.plotMesh()
